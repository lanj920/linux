...
{
	zynq_gpio_direction_output(0, 0);  // ps phy
	zynq_gpio_direction_output(46, 0); // emmc
	mdelay(100);
	zynq_gpio_direction_output(0, 1); // ps phy
	zynq_gpio_direction_output(46, 1); // emmc
	puts("gpio set comeplate\n");
	return 0;
}
#endif
