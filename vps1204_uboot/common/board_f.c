...
#ifdef CONFIG_MYGPIO
static int myGPIOset(void)
{
	int i,j=0;
	puts("GPIO:  ");
	zynq_gpio_direction_output(59, 0); // fiber0 
	zynq_gpio_direction_output(60, 0); // fiber1
	zynq_gpio_direction_output(61, 0); // fiber2 
	mdelay(100);
	zynq_gpio_direction_output(59, 1); // fiber0 
	zynq_gpio_direction_output(60, 1); // fiber1
	zynq_gpio_direction_output(61, 1); // fiber2 

	zynq_gpio_direction_output(48, 0); // ps phy
	zynq_gpio_direction_output(54, 0); // cps-1848
	zynq_gpio_direction_output(55, 0); // cps-1848
	zynq_gpio_direction_output(57, 0); // bcm5396 phy
	mdelay(100);
	zynq_gpio_direction_output(48, 1);
	zynq_gpio_direction_output(54, 1);
	zynq_gpio_direction_output(55, 1);
	zynq_gpio_direction_output(57, 1);

	mdelay(10);

	zynq_gpio_direction_output(56, 0); // bcm5396
	mdelay(100);
	zynq_gpio_direction_output(56, 1);
	puts("comeplate\n");
	return 0;
}
#endif
...
#endif
#ifdef CONFIG_MYGPIO
	myGPIOset,  // add gpio set
#endif
#ifdef CONFIG_MYSPI
	mySPI_init_r,  // add spi
#endif
	NULL,
};
